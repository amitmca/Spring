...
<td align='center'><a href="/SpringRESTFulServices/edit/${user.user_id}"><img src="<c:url value='/resources/images/b_edit.png'/>"/></a>&nbsp;&nbsp;<a href="/SpringRESTFulServices/delete/${user.user_id}"><img src="<c:url value='/resources/images/b_drop.png'/>"/></a></td>
</tr>
</c:forEach>
    </tbody>
</table>
