		...
		<table>
			...
			<c:forEach items="${userlist}" var="user">
				<tr>
					...
					<td align='center'><a href="<c:url value='/edit/${user.user_id}'/>"><img src="<c:url value='/resources/images/b_edit.png'/>"/></a>&nbsp;&nbsp;<a href="<c:url value='/delete/${user.user_id}'/>"><img src="<c:url value='/resources/images/b_drop.png'/>"/></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
