...
<title>Welcome to Baramati Bank-Netbanking</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/style.css" />

<!-- jQuery file -->
<script src="${pageContext.request.contextPath}/resources/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/jquery.tabify.js" type="text/javascript" charset="utf-8"></script>
...
<div id="panelwrap">
	...
	<div class="header">
    <div class="title"><img src="${pageContext.request.contextPath}/resources/images/bank.png"></div>
    ...
    <li><a href="#"><B>Third Party Transfer</B></a></li>
    <li><a href="#"><B>Billpay & Recharge</B></a></li>
    <li><a href="#"><B>Credit Cards</B></a></li>
    <li><a href="#"><B>Demat</B></a></li>
    <li><a href="#"><B>Mutual Funds</B></a></li>
    <li><a href="#"><B>Debit Cards</B></a></li>
    <li><a href="#"><B>Loans</B></a></li>
    </ul>
    </div>
...
<table id="rounded-corner">
    ...
    <tbody>
    	<tr class="odd">
            ...
            <td>web design</td>
            <td>Alex</td>
            <td><a href="#"><img src="${pageContext.request.contextPath}/resources/images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="#"><img src="${pageContext.request.contextPath}/resources/images/trash.gif" alt="" title="" border="0" /></a></td>
        </tr>
    	<tr class="even">
        	<td><input type="checkbox" name="" /></td>
    ...
    <h2>Accounts</h2>
        ...
        <ul>
            <li><a href="#" class="selected"><img src="${pageContext.request.contextPath}/resources/images/list-img.png" border=0> Accounts Summary</a></li>
            <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/list-img.png" border=0> View/Download Statement</a></li>
            <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/list-img.png" border=0> View Account Balance</a></li>
            <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/list-img.png" border=0> Mini Statement</a></li>
       </ul>
