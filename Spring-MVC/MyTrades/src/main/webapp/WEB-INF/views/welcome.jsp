    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <div class="box round first fullpage">
                ...
                <div class="block ">
                <fieldset>
                  <form:form action="/MyTrades/add" name="addForm" modelAttribute="usr" method="post" onSubmit="return checkInput(this)">
                    <table class="form">
                        <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:input path="firstName" cssClass="form_input" onkeydown= "return isAlpha(event.keyCode);"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:input path="lastName" class="form_input" onkeydown= "return isAlpha(event.keyCode);"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:input path="username" class="form_input"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:password path="password" class="form_input"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:input path="phone" class="form_input" onkeypress="return isNumberKey(event)" maxlength="10"/>
                            </td>
                        </tr>
                         <tr>
                            <td class="col1">
                            ...
                            <td class="col2">
                                <form:input path="emailId" class="form_input"/>
                            </td>
                        </tr>
                        <tr>
                        	<td>
                        	 <input type="submit" value="Save" name="save" class="btn btn-green"/> 
						   	</td>
                        </tr>
                    </table>
                   </form:form>
            ...
            <c:if test="${not empty showSearchedUser}"> 
	            <div class="box round first fullpage">
	                <h2>User Details</h2>
	                <c:choose>
		              	<c:when test="${!empty userSearched}">
							<div class="CSSTableGenerator" style="width:600px;height:150px;">
								<table>
									...
									<c:forEach items="${userSearched}" var="user">
										<tr>
