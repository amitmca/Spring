...
<td align='center'><a href="/SpringHibernateWithAnnotations/edit/${user.user_id}"><img src="<c:url value='/resources/images/b_edit.png'/>"/></a>&nbsp;&nbsp;<a href="/SpringHibernateWithAnnotations/delete/${user.user_id}"><img src="<c:url value='/resources/images/b_drop.png'/>"/></a></td>
</tr>
</c:forEach>
    </tbody>
</table>
