...
<div class="full_w">
	<div class="h_title"><img src="<c:url value='/resources/images/b_usradd.png'/>"/>&nbsp;&nbsp;Add New User</div>
	 <form:form action="/SpringHibernateWithAnnotations/save" name="addForm" modelAttribute="user" method="post" onSubmit="return checkInput(this)">
	 	<div class="element">
			<form:hidden path="user_id" cssClass="text" onkeydown= "return isAlpha(event.keyCode);"/>
		</div>
