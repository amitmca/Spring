		...
		<table>
			...
			<c:forEach items="${users}" var="user">
				<tr>
					...
					<td align='center'><a href="/SpringMyBatisWithXML/edit?id=${user.userId}"><img src="<c:url value='/resources/images/b_edit.png'/>"/></a>&nbsp;&nbsp;<a href="/SpringMyBatisWithXML/delete?id=${user.userId}"><img src="<c:url value='/resources/images/b_drop.png'/>"/></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
