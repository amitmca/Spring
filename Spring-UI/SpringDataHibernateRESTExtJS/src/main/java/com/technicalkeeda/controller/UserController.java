...
public class UserController {
	...
	public String loadExtJs(Locale locale, Model model) {
		return "index";
	}
    ...
    @RequestMapping(value = "/users/getuser/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
